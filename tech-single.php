...
<?php foreach ($post as $row){?>
                            <div class="single-post-media">
                                <img src="admin/uploads/images/<?php echo $row->post_img;?>" alt="" class="img-fluid">
                            </div><!-- end media -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="tech-single.php" title=""></a><?php echo $row->post_intro;?></h4>
                                                <small><a href="blog-category-01.html" title="">Trends</a></small>
                                                <small><a href="blog-category-01.html" title=""><?php echo $row->publish_date;?></a></small>
                                            </div><!-- end meta -->
                                        </div><!-- end blog-box -->
                                    </div><!-- end col -->
